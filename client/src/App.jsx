...
function App() {
  return (
    <div className="bg-gray-100 ">
      ...
      <div className="relative rounded-2xl p-10 w-full bg-cover bg-center bg-no-repeat" style={{ backgroundImage: 'url(https://coolbackgrounds.io/images/backgrounds/index/ranger-4df6c1b6.png)' }}>
  ...
  <div className="relative z-10">
    <div className="text-center mb-12">
      ...
      <p className="text-white text-lg">Explore the finest restaurants and dishes in your area</p>
    </div>
    <nav className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {[
        { to: "/restaurants", title: "Restaurant List", icon: "https://cdn-icons-png.flaticon.com/512/1376/1376387.png", color: "from-red-400 to-red-600" },
        { to: "/search/location", title: "Location Search", icon: "https://media.lordicon.com/icons/system/solid/42-search.svg", color: "from-purple-400 to-purple-600" },
        { to: "/search/image", title: "Image Search", icon: imgLink, color: "from-green-400 to-green-600" }
      ].map((item, index) => (
        <Link
          key={index}
          to={item.to}
        ...
        >
          <div className={`w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br ${item.color} p-4 group-hover:scale-110 transition-transform duration-300`}>
            <img src={item.icon} alt={item.title} className="w-full h-full object-contain filter invert"/>
          </div>
